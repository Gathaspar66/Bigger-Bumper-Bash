...
public class PointsManager : MonoBehaviour
{
    ...
    float speedPointMultiplier = 1;
    float lanePointMultiplier = 1;
    float cratePointMultiplier = 1;
    float cratePointMultiplierMax = 3;
    float cratePointMultiplierTimer = 0;
    float cratePointMultiplierTimerMax = 5;
